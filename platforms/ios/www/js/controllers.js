...
.controller('ListsCtrl', function($scope, listsService, $state, PostsServices, $ionicLoading) {
  ...
  $scope.changeTabColor = function(){
    document.getElementById('sell').background = '#3A7E45';
    document.getElementById(''). = '#4da75c';
  };
...
.controller('ListingsCtrl', function($scope, $state, PostsServices) {
  ...
  $scope.changeTabColor = function(){
    document.getElementById('find').background = '#3A7E45';
    document.getElementById('sell').background = '#4da75c';
  };
})
